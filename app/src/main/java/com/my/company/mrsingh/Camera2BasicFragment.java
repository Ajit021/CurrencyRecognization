...
public class Camera2BasicFragment extends Fragment
  ...
  private void classifyFrame() {
    ...
    String text=textToShow;
      if(text.compareTo("Uninitialized Classifier or invalid context.")!=0) {
          int m = text.indexOf(":");
          int k=text.indexOf("_");
          String toSpeak=text.substring(10,k);
          String s = text.substring(m + 1, m + 3);
          Log.e(TAG,toSpeak);
             ...
             tts=new TextToSpeech(getActivity().getApplicationContext(), new TextToSpeech.OnInitListener() {
               ...
               public void onInit(int i) {
                 if (i == TextToSpeech.SUCCESS) {
                   ...
                   speakOut(toSpeak+"Rupee Note ");
                   for(int o=0;o<100000;o++){
                     int m=0;
                     m++;

                   }
                   Log.e(TAG,"SPEAKING"+toSpeak);
    ...
    tts.setOnUtteranceProgressListener(new UtteranceProgressListener() {
      ...
      public void onStart(String s) {
        ...
        getActivity().runOnUiThread(new Runnable() {
          @Override
          public void run() {
            //Toast.makeText(getActivity().getApplicationContext(), "WELCOME" + keyword, Toast.LENGTH_SHORT).show();
          }
        });
      }
